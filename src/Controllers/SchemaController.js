...
const injectDefaultSchema = ({className, fields = {}, classLevelPermissions }: Schema) => ({
  className,
  fields: {
...
export default class SchemaController {
  ...
  addClassIfNotExists(className: string, fields: SchemaFields = {}, classLevelPermissions: any): Promise<void> {
  ...
  updateClass(className: string, submittedFields: SchemaFields, classLevelPermissions: any, database: DatabaseController) {
