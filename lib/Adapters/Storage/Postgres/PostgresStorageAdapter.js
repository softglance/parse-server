...
var PostgresStorageAdapter = exports.PostgresStorageAdapter = function () {
  ...
  _createClass(PostgresStorageAdapter, [{
    ...
    value: function find(className, schema, query, _ref3) {
      ...
      return this._client.any(qs, values).catch(function (err) {
        ...
        return results.map(function (object) {
          return _this9.postgresObjectToParseObject(className, object, schema);
        });
      });
    }
    ...
    key: 'postgresObjectToParseObject',
    value: function postgresObjectToParseObject(className, object, schema) {
    ...
    value: function distinct(className, schema, query, fieldName) {
      ...
      return this._client.any(qs, values).catch(function () {
        ...
        return results.map(function (object) {
          return _this10.postgresObjectToParseObject(className, object, schema);
        });
      });
    }
  }, {
    key: 'aggregate',
    value: function aggregate(className, schema, pipeline) {
      var _this11 = this;
      ...
      return this._client.any(qs, values).then(function (results) {
        return results.map(function (object) {
          return _this11.postgresObjectToParseObject(className, object, schema);
        });
      }).then(function (results) {
        if (countField) {
    ...
    value: function performInitialization(_ref4) {
      ...
      var promises = VolatileClassesSchemas.map(function (schema) {
        return _this12.createTable(schema.className, schema).catch(function (err) {
      ...
      return Promise.all(promises).then(function () {
        return _this12._client.tx(function (t) {
